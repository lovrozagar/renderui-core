const DEFAULT_NAVIGATION_MENU_CLASSNAME =
  'render-ui-navigation-menu relative z-[1] flex w-fit justify-center'
...
const DEFAULT_NAVIGATION_MENU_VIEWPORT_CONTAINER_CLASSNAME =
  'render-ui-navigation-menu-viewport-container absolute z-[1] left-0 top-full flex w-fit justify-center perspective-[2000px]'
