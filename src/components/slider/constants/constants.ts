const DEFAULT_SLIDER_CLASSNAME =
	'_slider group/slider relative flex touch-none select-none items-center data-[disabled]:opacity-40 data-[disabled]:cursor-not-allowed'
...
const DEFAULT_SLIDER_RANGE_CLASSNAME = '_slider-range absolute bg-primary'
