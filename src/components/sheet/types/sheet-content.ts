...
type SheetContentPrimitiveProps = React.ComponentPropsWithRef<
  typeof SheetContentPrimitive
>;

type SheetContentRenderUIProps = NonNullableVariantProps<
  typeof sheetClasses
> & {
...
type SheetContentProps = Simplify<
  SheetContentPrimitiveProps & SheetContentRenderUIProps
>;
