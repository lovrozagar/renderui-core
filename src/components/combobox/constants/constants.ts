const DEFAULT_COMBOBOX_TRIGGER_CLASSNAME =
	'_combobox-trigger group justify-between min-h-[40px] transition-[background-color,box-shadow] data-[empty=true]:text-mode-foreground/50 aria-[expanded=true]:ring-[rgba(var(--root-color))] aria-[expanded=true]:ring-[1px] ring-offset-0 data-[focus-visible]:ring-offset-0 data-[hover=true]:ring-[rgba(var(--root-color))] data-[hover=true]:ring-[1px] data-[expanded=true]:ring-[2px] data-[hover=true]:data-[focus-visible=true]:ring-[2px] data-[expanded=true]:data-[hover=true]:ring-[2px] data-[invalid=true]:data-[expanded=true]:ring-destructive data-[invalid=true]:ring-destructive data-[value-type=placeholder]:text-mode-foreground/50'
...
const DEFAULT_COMBOBOX_TRIGGER_ICON_CLASSNAME =
	'_combobox-trigger-icon inline-block h-4 w-4 shrink-0 opacity-50 text-mode-foreground transition-[transform] duration-fast group-aria-expanded:rotate-[-90deg]'

const DEFAULT_COMBOBOX_INPUT_CLASSNAME = '_combobox-content h-9'

const DEFAULT_COMBOBOX_ITEM_CLASSNAME = '_combobox-item flex items-center gap-2 break-all'

const DEFAULT_COMBOBOX_ITEM_CHECK_ICON_CLASSNAME =
	'_combobox-item-check-icon ml-auto h-4 w-4 shrink-0 opacity-0'

const COMBOBOX_ITEM_CHECK_ICON_CHECKED_CLASSNAME = 'opacity-100'

const DEFAULT_INPUT_CONTAINER_CLASSNAME = 'border-none'

const COMBOBOX_INPUT_CONTAINER_CLASSNAME = '_combobox-input-container'
...
const DEFAULT_COMBOBOX_SCROLL_AREA_CLASSNAME = '_combobox-scroll-area w-[7px]'

const DEFAULT_COMBOBOX_SCROLL_AREA_SCROLLBAR_CLASSNAME =
	'_combobox-scroll-area-scrollbar max-h-80 bg-transparent sm:max-h-80'
